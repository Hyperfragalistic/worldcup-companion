...
export const ROSTERS: Record<string, Player[]> = {
  ...
  'South Africa': [
    ...
    { name: 'Evidence Makgopa',   number: 19, position: 'FWD', club: 'Orlando Pirates',    caps:  22, goals: 8 },
  ],
  ...
  Australia: [
    ...
    { name: 'Riley McGree',       number: 18, position: 'MID', club: 'Middlesbrough',       caps:  35, goals: 7 },
  ...
  Curacao: [
    ...
    { name: 'Rangelo Janga',      number:  5, position: 'FWD', club: 'SC Telstar',         caps:  28, goals: 2 },
    { name: 'Riechedly Bazoer',   number:  4, position: 'MID', club: 'Vitesse',            caps:  22, goals: 1 },
  ...
  Ecuador: [
    ...
    { name: 'Carlos Gruezo',      number: 15, position: 'MID', club: 'Augsburg',            caps:  53, goals: 1 },
  ...
  Japan: [
    ...
    { name: 'Takumi Minamino',    number: 11, position: 'FWD', club: 'Monaco',              caps:  62, goals: 21 },
  ...
  Sweden: [
    ...
    { name: 'Dejan Kulusevski',   number: 21, position: 'MID', club: 'Tottenham Hotspur',  caps:  44, goals: 9 },
  ...
  Iran: [
    ...
    { name: 'Ali Gholizadeh',     number: 11, position: 'FWD', club: 'Chartres FC',        caps:  38, goals: 6 },
    ...
    { name: 'Saman Ghoddos',      number: 14, position: 'FWD', club: 'Brentford',          caps:  46, goals: 11 },
  ],
  ...
  Senegal: [
    ...
    { name: 'Pape Matar Sarr',    number: 14, position: 'MID', club: 'Tottenham Hotspur',  caps:  24, goals: 3 },
  ...
  Norway: [
    ...
    { name: 'Sander Berge',       number: 23, position: 'MID', club: 'Fulham',              caps:  44, goals: 7 },
  ...
  Austria: [
    ...
    { name: 'Florian Grillitsch', number: 21, position: 'MID', club: 'Hoffenheim',         caps:  42, goals: 5 },
  ...
  England: [
    ...
    { name: 'Trent Alexander-Arnold',number:  2, position: 'DEF', club: 'Real Madrid',       caps:  36, goals: 3 },
    ...
    { name: 'Phil Foden',         number: 11, position: 'MID', club: 'Manchester City',    caps:  34, goals: 4 },
  ...
  Ghana: [
    ...
    { name: 'Thomas Partey',      number:  8, position: 'MID', club: 'Arsenal',             caps:  48, goals: 14 },
